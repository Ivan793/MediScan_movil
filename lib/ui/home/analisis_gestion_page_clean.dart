          ...
          child: Container(
            ...
            child: TabBar(
              ...
              tabs: const [
                ...
                Tab(icon: Icon(Icons.pending_actions, size: 20), text: "Pendientes"),
              ],
            ),
          ),
        ),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  analisis.pacienteId, // Using pacienteId since nombrePaciente doesn't exist
                  style: const TextStyle(
                    fontWeight: FontWeight.bold,
                    fontSize: 16,
                    color: AppColors.textPrimary,
                ...
                children: [
                  ...
                  Center(
                    child: Column(
                      children: [
                        Text(
                          a.pacienteId, // Using pacienteId instead of nombrePaciente
